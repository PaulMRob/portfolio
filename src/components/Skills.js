    ...
    <>
      ...
      <div
        className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight 
          ...
          lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightLg md:dark:bg-circularDarkLg sm:bg-circularLightMd sm:dark:bg-circularDarkSm"
      >
        <motion.div
        ...
        <Skill name="Project Management" x="0vw" y="-20vw" />
