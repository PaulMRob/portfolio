  ...
  return (
    <article className="w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 dark:bg-dark dark:border-light">
      ...
      <Link
        href={link}
        target="_blank"
        className="w-1/2 cursor-pointer overflow-hidden rounded-lg dark:bg-light dark:text-dark"
      >
        <FramerImage
          src={img}
          alt={title}
      ...
      <div className="w-1/2 flex flex-col items-start jusftify-between pl-6 dark:text-primaryDark">
        ...
        >
          <h2 className="my-2 width-full text-left text-4xl font-bold dark:text-light">
            {title}
          </h2>
        </Link>
